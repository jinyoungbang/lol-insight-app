  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <div className={classes.padding}>
        ...
        <p>
          At Daiv, accessible from daiv.app, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types
          of information that is collected and recorded by DAIV and how we use
          it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in DAIV. This policy is not applicable to any
        ...
        <p>
          Daiv follows a standard procedure of using log files. These files log
        ...
        <p>
          ...
          advertising partners of Daiv.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Daiv, which are sent directly
        ...
        <p>
          Note that Daiv has no access to or control over these cookies that are
        ...
        <p>
          Daiv's Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          Daiv does not knowingly collect any Personal Identifiable Information
